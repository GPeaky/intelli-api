use crate::{
    handlers::{
        ...
        championships::{
            add_user, all_championships, create_championship, get_championship, session_socket,
            socket_status, start_socket, stop_socket, update,
        },
        heartbeat,
...
pub(crate) fn api_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/championships")
            ...
            .route("/{id}/add_user", web::put().to(add_user))
